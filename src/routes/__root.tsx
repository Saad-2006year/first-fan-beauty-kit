...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated Korean skincare and wellness essentials in Pakistan." },
      { name: "author", content: "First Fan Beauty (Private) Limited" },
      { property: "og:title", content: "FIRST FAN" },
      { property: "og:description", content: "K-Beauty, First Choice." },
